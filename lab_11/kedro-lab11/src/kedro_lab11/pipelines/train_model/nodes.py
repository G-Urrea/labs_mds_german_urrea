...
def train_model(x_train, y_train, x_val, y_val):
    # registrar automáticamente información del entrenamiento
    # mlflow.autolog()
    models = [
        LinearRegression(),
    ...
    if experiment is None:
        exp_id = mlflow.create_experiment("Entrenamiento de modelos de regresión")
    else:
    ...
    for model in models:
        ...
        with mlflow.start_run(
            experiment_id=exp_id, run_name=f"Entrenar modelo: {model_name}"
        ):
